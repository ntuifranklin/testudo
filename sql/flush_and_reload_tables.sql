...
CREATE TABLE IF NOT EXISTS `ASSIGNMENT` (
  ...
  `CID` varchar(100) NOT NULL REFERENCES COURSE(`CID`),
...
CREATE TABLE IF NOT EXISTS `STUDENTSUBMITSASSIGNMENT` (
  `SUBMISSIONID` varchar(100) PRIMARY KEY NOT NULL,
  `ASSIGNMENTID` varchar(100) NOT NULL REFERENCES ASSIGNMENT(`ASSIGNMENTID`),
  `CID` varchar(100) NOT NULL REFERENCES COURSE(`CID`),
